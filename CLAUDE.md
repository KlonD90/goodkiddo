...
- Prepared follow-up draft artifacts live in `bot/src/capabilities/prepared_followups/`; `prepare_draft_artifact(type, title?, task, context?, evidence?, source_paths?, source_urls?)` creates internal `/prepared-followups/*.md` drafts only.
