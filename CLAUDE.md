...
- `src/capabilities/attachment_budget.ts` is the shared seam for deciding whether attachment output fits, requires compaction, or must be rejected before injection.
