...
- [x] Move the completed `feature-forced-checkpoints-and-conversation-compaction.md` row in `docs/features/README.md` to show the new feature under "Active plans"; link this execution plan from the feature doc.
