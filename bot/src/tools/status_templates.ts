...
const ALLOWLISTED_ARGS: Record<string, readonly string[]> = {
	...
	prepare_draft_artifact: ["type", "task"],
...
const dictionaries: LocaleDictionary = {
	en: {
		...
		prepare_draft_artifact: "Preparing draft artifact: {task}",
	...
	ru: {
		...
		prepare_draft_artifact: "Подготовка черновика: {task}",
	...
	es: {
		...
		prepare_draft_artifact: "Preparando borrador: {task}",
