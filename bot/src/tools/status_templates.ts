...
const ALLOWLISTED_ARGS: Record<string, readonly string[]> = {
	...
	prepare_draft_artifact: ["type", "title", "task"],
...
const dictionaries: LocaleDictionary = {
	en: {
		...
		prepare_draft_artifact: "Preparing draft artifact: {title}",
	...
	ru: {
		...
		prepare_draft_artifact: "Подготовка черновика: {title}",
	...
	es: {
		...
		prepare_draft_artifact: "Preparando borrador: {title}",
