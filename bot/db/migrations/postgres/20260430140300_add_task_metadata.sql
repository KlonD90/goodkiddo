-- migrate:up
ALTER TABLE tasks ADD COLUMN due_at BIGINT;
ALTER TABLE tasks ADD COLUMN next_check_at BIGINT;
...
ALTER TABLE tasks ADD COLUMN last_nudged_at BIGINT;
ALTER TABLE tasks ADD COLUMN nudge_count INTEGER NOT NULL DEFAULT 0;
ALTER TABLE tasks ADD COLUMN snoozed_until BIGINT;
